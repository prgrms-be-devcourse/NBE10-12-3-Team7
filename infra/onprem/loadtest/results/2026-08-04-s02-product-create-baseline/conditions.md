# 측정 조건 — s02-product-create / baseline

실행 직전에 스크립트가 실제 값을 읽어 남긴 것이다. 손으로 고치지 않는다.

| 항목 | 값 |
|---|---|
| 실행 시각 | 2026-08-04 14:41:43 KST |
| 스크립트 버전 | `40da401` |
...
| k6 → Prometheus | `http://prometheus:9090/api/v1/write` · testid=`2026-08-04-s02-product-create-baseline` |
